<template><div><p><img src="pictures/1.png" alt="黑白米白色文学作品中式文化宣传中文书籍封面 (1)"></p>
...
<h1 id="java概述以及环境变量的配置" tabindex="-1"><a class="header-anchor" href="#java概述以及环境变量的配置" aria-hidden="true">#</a> java概述以及环境变量的配置</h1>
<h2 id="为什么选择java" tabindex="-1"><a class="header-anchor" href="#为什么选择java" aria-hidden="true">#</a> 为什么选择java</h2>
...
<h2 id="为什么java最广泛" tabindex="-1"><a class="header-anchor" href="#为什么java最广泛" aria-hidden="true">#</a> 为什么java最广泛</h2>
...
<h2 id="java简介" tabindex="-1"><a class="header-anchor" href="#java简介" aria-hidden="true">#</a> java简介</h2>
...
<h2 id="关于java的常见误解" tabindex="-1"><a class="header-anchor" href="#关于java的常见误解" aria-hidden="true">#</a> 关于java的常见误解</h2>
<p>当然，关于安装的这部分，这个书就不做解释了，也可能以后会做解释，目前是不做解释了。话不多说，直接开始下面的学习。</p>
<h1 id="java语法基础" tabindex="-1"><a class="header-anchor" href="#java语法基础" aria-hidden="true">#</a> java语法基础</h1>
...
<p><img src=".\pictures\image-20230614125030250.png" alt="image-20230614125030250"></p>
</li>
</ul>
...
<h2 id="java标识符" tabindex="-1"><a class="header-anchor" href="#java标识符" aria-hidden="true">#</a> java标识符</h2>
...
<h2 id="java修饰符" tabindex="-1"><a class="header-anchor" href="#java修饰符" aria-hidden="true">#</a> java修饰符</h2>
...
<h2 id="java变量" tabindex="-1"><a class="header-anchor" href="#java变量" aria-hidden="true">#</a> java变量</h2>
<p>什么是变量？</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> 变量练习之计算公交车的人数 <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="java关键字" tabindex="-1"><a class="header-anchor" href="#java关键字" aria-hidden="true">#</a> java关键字</h2>
...
<p><img src="pictures/override-overload-20230408151129.png" alt="img"></p>
...
<h2 id="java注释" tabindex="-1"><a class="header-anchor" href="#java注释" aria-hidden="true">#</a> java注释</h2>
...
<p><img src="pictures/image-20230614133117174.png" alt="image-20230614133117174"></p>
<p>01、单行注释</p>
...
<p><img src="pictures/fourteen-02.png" alt="img"></p>
...
<p><img src="pictures/fourteen-08.png" alt="img"></p>
...
<p><img src="pictures/fourteen-09.png" alt="img"></p>
...
<p><img src="pictures/fourteen-10.png" alt="img"></p>
<p>语法如下所示：</p>
...
<h2 id="java数据类型" tabindex="-1"><a class="header-anchor" href="#java数据类型" aria-hidden="true">#</a> java数据类型</h2>
...
<p>来个思维导图，感受下。</p>
<p><img src="pictures/nine-01.png" alt="img"></p>
...
<h3 id="_01、比特和字节" tabindex="-1"><a class="header-anchor" href="#_01、比特和字节" aria-hidden="true">#</a> 01、比特和字节</h3>
<p>比特币（Bitcoin）听说过吧？字节跳动（Byte Dance）听说过吧？这些名字当然不是乱起的，确实和比特、字节有关系。</p>
<h4 id="_1-bit-比特" tabindex="-1"><a class="header-anchor" href="#_1-bit-比特" aria-hidden="true">#</a> 1）bit（比特）</h4>
<p>比特作为信息技术的最基本存储单位，非常小，但大名鼎鼎的比特币就是以此命名的，它的简写为小写字母“b”。</p>
<p>大家都知道，计算机是以二进制存储数据的，二进制的一位，就是 1 比特，也就是说，比特要么为 0 要么为 1。</p>
<h4 id="_2-byte-字节" tabindex="-1"><a class="header-anchor" href="#_2-byte-字节" aria-hidden="true">#</a> <strong>2）Byte（字节）</strong></h4>
<p>通常来说，一个英文字符是一个字节，一个中文字符是两个字节。字节与比特的换算关系是：1 字节 = 8 比特。</p>
<p>在往上的单位就是 KB，并不是 1000 字节，因为计算机只认识二进制，因此是 2 的 10 次方，也就是 1024 个字节。</p>
<p><img src="pictures/nine-03.png" alt="img"></p>
<h3 id="_02-基本数据类型" tabindex="-1"><a class="header-anchor" href="#_02-基本数据类型" aria-hidden="true">#</a> 02.基本数据类型</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="字符串型" tabindex="-1"><a class="header-anchor" href="#字符串型" aria-hidden="true">#</a> 字符串型</h4>
...
<h3 id="_04、引用数据类型" tabindex="-1"><a class="header-anchor" href="#_04、引用数据类型" aria-hidden="true">#</a> 04、引用数据类型</h3>
...
<p><img src="pictures/nine-06.png" alt="img"></p>
...
<p><img src="pictures/nine-07.png" alt="img"></p>
...
<h3 id="_05、栈和堆" tabindex="-1"><a class="header-anchor" href="#_05、栈和堆" aria-hidden="true">#</a> 05、栈和堆</h3>
...
<p><img src="pictures/basic-data-type-dc26645a-3ed8-4ad4-815d-52528ad12d6b.png" alt="img"></p>
...
<p><img src="pictures/basic-data-type-3d5b3e40-1abb-4624-8282-b83e58388825.png" alt="img"></p>
<p>应该一目了然了吧？如果还不理解，以后我会再一些面试题中，更新这些的具体讲解的。</p>
<h3 id="_06、数据类型之间的转换" tabindex="-1"><a class="header-anchor" href="#_06、数据类型之间的转换" aria-hidden="true">#</a> 06、数据类型之间的转换</h3>
<p>数据类型转换的目的是确保在表达式求值时，不同类型的数据能够相互兼容。</p>
<h4 id="_01、自动类型转换" tabindex="-1"><a class="header-anchor" href="#_01、自动类型转换" aria-hidden="true">#</a> 01、自动类型转换</h4>
...
<h4 id="_02、强制类型转换" tabindex="-1"><a class="header-anchor" href="#_02、强制类型转换" aria-hidden="true">#</a> 02、强制类型转换</h4>
...
<h3 id="_07、缓存池" tabindex="-1"><a class="header-anchor" href="#_07、缓存池" aria-hidden="true">#</a> 07、缓存池</h3>
...
<h2 id="java运算符" tabindex="-1"><a class="header-anchor" href="#java运算符" aria-hidden="true">#</a> java运算符</h2>
...
<p>下面我们要学习的，大概就是下图</p>
<p><img src="pictures/eleven-01.png" alt="img"></p>
<h3 id="_01、算术运算符" tabindex="-1"><a class="header-anchor" href="#_01、算术运算符" aria-hidden="true">#</a> 01、算术运算符</h3>
...
<h3 id="_02、关系运算符" tabindex="-1"><a class="header-anchor" href="#_02、关系运算符" aria-hidden="true">#</a> 02、关系运算符</h3>
<p>关系运算符用来比较两个操作数，返回结果为 true 或者 false。</p>
<p><img src="pictures/eleven-02.png" alt="img"></p>
<p>来看示例：</p>
...
<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>a <span class="token operator">>=</span> b<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// false</span>
<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>a <span class="token operator">&lt;=</span> b<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_03、位运算符" tabindex="-1"><a class="header-anchor" href="#_03、位运算符" aria-hidden="true">#</a> 03、位运算符</h3>
...
<p><img src="pictures/eleven-03.png" alt="img"></p>
<p>来看示例：</p>
...
<h3 id="_04、逻辑运算符" tabindex="-1"><a class="header-anchor" href="#_04、逻辑运算符" aria-hidden="true">#</a> 04、逻辑运算符</h3>
...
<p><img src="pictures/eleven-04.png" alt="img"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_06、三元运算符" tabindex="-1"><a class="header-anchor" href="#_06、三元运算符" aria-hidden="true">#</a> 06、三元运算符</h3>
...
<h3 id="_07、运算符优先级" tabindex="-1"><a class="header-anchor" href="#_07、运算符优先级" aria-hidden="true">#</a> 07、运算符优先级</h3>
...
<h2 id="java流程控制语句" tabindex="-1"><a class="header-anchor" href="#java流程控制语句" aria-hidden="true">#</a> java流程控制语句</h2>
...
<h3 id="_01、if-else-相关" tabindex="-1"><a class="header-anchor" href="#_01、if-else-相关" aria-hidden="true">#</a> 01、if-else 相关</h3>
<p><img src="pictures/thirteen-01.png" alt="img"></p>
<h4 id="_1-if-语句" tabindex="-1"><a class="header-anchor" href="#_1-if-语句" aria-hidden="true">#</a> <strong>1）if 语句</strong></h4>
<p>if 语句的格式如下：</p>
...
<p><img src="pictures/thirteen-02.png" alt="img"></p>
<p>来写个示例：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_2-if-else-语句" tabindex="-1"><a class="header-anchor" href="#_2-if-else-语句" aria-hidden="true">#</a> <strong>2）if-else 语句</strong></h4>
<p>if-else 语句的格式如下:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">if</span><span class="token punctuation">(</span>布尔表达式<span class="token punctuation">)</span><span class="token punctuation">{</span>  
...
<p><img src="pictures/thirteen-03.png" alt="img"></p>
<p>来写个示例：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_3-if-else-if-语句" tabindex="-1"><a class="header-anchor" href="#_3-if-else-if-语句" aria-hidden="true">#</a> <strong>3）if-else-if 语句</strong></h4>
...
<p><img src="pictures/thirteen-04.png" alt="img"></p>
<p>来写个示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">int</span> age <span class="token operator">=</span> <span class="token number">31</span><span class="token punctuation">;</span>
<span class="token keyword">if</span> <span class="token punctuation">(</span>age <span class="token operator">&lt;</span> <span class="token number">30</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"青春年华"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>而立之年
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_4-if-嵌套语句" tabindex="-1"><a class="header-anchor" href="#_4-if-嵌套语句" aria-hidden="true">#</a> <strong>4）if 嵌套语句</strong></h4>
<p>if 嵌套语句的格式如下：</p>
...
<p><img src="pictures/thirteen-05.png" alt="img"></p>
<p>来写个示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">int</span> age <span class="token operator">=</span> <span class="token number">20</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_02、switch-语句" tabindex="-1"><a class="header-anchor" href="#_02、switch-语句" aria-hidden="true">#</a> 02、switch 语句</h3>
...
<p>画个流程图：</p>
<p><img src="pictures/thirteen-06.png" alt="img"></p>
<p>来个示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">int</span> age <span class="token operator">=</span> <span class="token number">20</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_03、for-循环" tabindex="-1"><a class="header-anchor" href="#_03、for-循环" aria-hidden="true">#</a> 03、for 循环</h3>
<p><img src="pictures/thirteen-07.png" alt="img"></p>
<h4 id="_1-普通-for-循环" tabindex="-1"><a class="header-anchor" href="#_1-普通-for-循环" aria-hidden="true">#</a> <strong>1）普通 for 循环</strong></h4>
...
<p><img src="pictures/thirteen-08.png" alt="img"></p>
<p>来个示例：</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>xiaou
一枚有趣的程序员
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-无限-for-循环" tabindex="-1"><a class="header-anchor" href="#_3-无限-for-循环" aria-hidden="true">#</a> <strong>3）无限 for 循环</strong></h4>
...
<h3 id="_04、while-循环" tabindex="-1"><a class="header-anchor" href="#_04、while-循环" aria-hidden="true">#</a> 04、while 循环</h3>
...
<p><img src="pictures/thirteen-09.png" alt="img"></p>
<p>来个示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span>
...
<h3 id="_05、do-while-循环" tabindex="-1"><a class="header-anchor" href="#_05、do-while-循环" aria-hidden="true">#</a> 05、do-while 循环</h3>
...
<p><img src="pictures/thirteen-10.png" alt="img"></p>
<p>来个示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span>
<span class="token keyword">do</span> <span class="token punctuation">{</span>
...
<p><img src="pictures/thirteen-11.png" alt="img"></p>
<h3 id="_06、break" tabindex="-1"><a class="header-anchor" href="#_06、break" aria-hidden="true">#</a> 06、break</h3>
...
<p>来画个流程图感受一下：</p>
<p><img src="pictures/thirteen-12.png" alt="img"></p>
<p>用在 for 循环中的示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span> i <span class="token operator">&lt;=</span> <span class="token number">10</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span>i <span class="token operator">==</span> <span class="token number">5</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">break</span><span class="token punctuation">;</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">switch</span> <span class="token punctuation">(</span>age<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">default</span><span class="token operator">:</span>
        ...
        <span class="token keyword">break</span><span class="token punctuation">;</span> <span class="token comment">// 可省略</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_07、continue" tabindex="-1"><a class="header-anchor" href="#_07、continue" aria-hidden="true">#</a> 07、continue</h3>
...
<h3 id="_08、switch-case-语句" tabindex="-1"><a class="header-anchor" href="#_08、switch-case-语句" aria-hidden="true">#</a> 08、switch case 语句</h3>
...
<h3 id="_1-回文数-正序和倒序一样的整数" tabindex="-1"><a class="header-anchor" href="#_1-回文数-正序和倒序一样的整数" aria-hidden="true">#</a> 1.*回文数：正序和倒序一样的整数</h3>
<ul>
<li>例如121</li>
<li>12321</li>
</ul>
...
<h3 id="_2-给定两个整数-被除数和除数-将两个数相除-要求不能使用除法。乘法和取余" tabindex="-1"><a class="header-anchor" href="#_2-给定两个整数-被除数和除数-将两个数相除-要求不能使用除法。乘法和取余" aria-hidden="true">#</a> 2.给定两个整数，被除数和除数，将两个数相除，要求不能使用除法。乘法和取余</h3>
<ul>
<li>最后要得到商和余数</li>
</ul>
...
<h1 id="数组-字符串" tabindex="-1"><a class="header-anchor" href="#数组-字符串" aria-hidden="true">#</a> 数组 &amp; 字符串</h1>
<h2 id="java数组" tabindex="-1"><a class="header-anchor" href="#java数组" aria-hidden="true">#</a> java数组</h2>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">RunoobTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="二维数组" tabindex="-1"><a class="header-anchor" href="#二维数组" aria-hidden="true">#</a> 二维数组</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="打印java数组" tabindex="-1"><a class="header-anchor" href="#打印java数组" aria-hidden="true">#</a> 打印java数组</h3>
...
<h4 id="stream-流打印-java-数组" tabindex="-1"><a class="header-anchor" href="#stream-流打印-java-数组" aria-hidden="true">#</a> stream 流打印 Java 数组</h4>
...
<h4 id="for-循环打印-java-数组" tabindex="-1"><a class="header-anchor" href="#for-循环打印-java-数组" aria-hidden="true">#</a> for 循环打印 Java 数组</h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="arrays-工具类打印-java-数组" tabindex="-1"><a class="header-anchor" href="#arrays-工具类打印-java-数组" aria-hidden="true">#</a> Arrays 工具类打印 Java 数组</h4>
...
<p><img src="pictures/print-01.png" alt="img"></p>
...
<h4 id="arrays工具类打印二维数组" tabindex="-1"><a class="header-anchor" href="#arrays工具类打印二维数组" aria-hidden="true">#</a> Arrays工具类打印二维数组</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="pojo-的打印规约" tabindex="-1"><a class="header-anchor" href="#pojo-的打印规约" aria-hidden="true">#</a> POJO 的打印规约</h4>
<p>阿里巴巴的 Java 开发手册上有这样一条规约：</p>
<p><img src="pictures/print-03.png" alt="img"></p>
...
<h2 id="java-string类" tabindex="-1"><a class="header-anchor" href="#java-string类" aria-hidden="true">#</a> Java String类</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="pictures/java-string-1-2020-12-01.png" alt="img"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="string-方法" tabindex="-1"><a class="header-anchor" href="#string-方法" aria-hidden="true">#</a> String 方法</h2>
...
<h2 id="解读string源码" tabindex="-1"><a class="header-anchor" href="#解读string源码" aria-hidden="true">#</a> 解读String源码</h2>
<p>我们以java8的为例进行解读，这里也是涉及到面试的东西，可以当做一个了解</p>
<h3 id="string-类的声明" tabindex="-1"><a class="header-anchor" href="#string-类的声明" aria-hidden="true">#</a> String 类的声明</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">final</span> <span class="token keyword">class</span> <span class="token class-name">String</span>
    <span class="token keyword">implements</span> <span class="token class-name"><span class="token namespace">java<span class="token punctuation">.</span>io<span class="token punctuation">.</span></span>Serializable</span><span class="token punctuation">,</span> <span class="token class-name">Comparable</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">String</span><span class="token punctuation">></span></span><span class="token punctuation">,</span> <span class="token class-name">CharSequence</span> <span class="token punctuation">{</span>
<span class="token punctuation">}</span>
...
<h3 id="string-类的底层实现" tabindex="-1"><a class="header-anchor" href="#string-类的底层实现" aria-hidden="true">#</a> String 类的底层实现</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">final</span> <span class="token keyword">char</span> value<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
...
<p><img src="pictures/jdk9-char-byte-string-d826ce88-bbbe-47a3-a1a9-4dd86dd3632f.png" alt="img"></p>
...
<h3 id="类的-hashcode-方法" tabindex="-1"><a class="header-anchor" href="#类的-hashcode-方法" aria-hidden="true">#</a> 类的 hashCode 方法</h3>
...
<h3 id="string-类的-substring-方法" tabindex="-1"><a class="header-anchor" href="#string-类的-substring-方法" aria-hidden="true">#</a> String 类的 substring 方法</h3>
...
<h3 id="string-类的-indexof-方法" tabindex="-1"><a class="header-anchor" href="#string-类的-indexof-方法" aria-hidden="true">#</a> String 类的 indexOf 方法</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="类的其他方法" tabindex="-1"><a class="header-anchor" href="#类的其他方法" aria-hidden="true">#</a> 类的其他方法</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="string字符串为什么不可变" tabindex="-1"><a class="header-anchor" href="#string字符串为什么不可变" aria-hidden="true">#</a> string字符串为什么不可变</h2>
...
<p><img src="pictures/image-20191210004132894.png" alt="img"></p>
<p>string pool也叫做字符串常量值，这个之后会介绍的。</p>
<h2 id="string-pool" tabindex="-1"><a class="header-anchor" href="#string-pool" aria-hidden="true">#</a> String Pool</h2>
...
<h2 id="string-stringbuffer-and-stringbuilder" tabindex="-1"><a class="header-anchor" href="#string-stringbuffer-and-stringbuilder" aria-hidden="true">#</a> String, StringBuffer and StringBuilder</h2>
...
<h2 id="new-string-abc" tabindex="-1"><a class="header-anchor" href="#new-string-abc" aria-hidden="true">#</a> new String(&quot;abc&quot;)</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="java-字符串优化-详解-string-intern-方法" tabindex="-1"><a class="header-anchor" href="#java-字符串优化-详解-string-intern-方法" aria-hidden="true">#</a> Java 字符串优化：详解 String.intern() 方法</h2>
...
<p>他的构造方法。</p>
<p><img src="pictures/image-20230615151118413.png" alt="image-20230615151118413"></p>
<p>之后看他的成员方法</p>
<p><img src="pictures/image-20230615151125636.png" alt="image-20230615151125636"></p>
<p>看他一个简单的应用</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> 字符串<span class="token punctuation">;</span>
...
<h2 id="字符串相等判断-java中的equals-与-的区别与用法" tabindex="-1"><a class="header-anchor" href="#字符串相等判断-java中的equals-与-的区别与用法" aria-hidden="true">#</a> 字符串相等判断：Java中的equals()与==的区别与用法</h2>
...
<p><img src="pictures/image-20230615152328622.png" alt="image-20230615152328622"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> 字符串<span class="token punctuation">;</span>
...
<p><img src="pictures/image-20230615152950182.png" alt="image-20230615152950182"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> 字符串<span class="token punctuation">;</span>
<span class="token comment">/*
 */</span>
...
<p>整个程序实现简单，通过方法的封装和调用，使得代码的可读性和可维护性都得到了提高。</p>
<h1 id="总结-后记" tabindex="-1"><a class="header-anchor" href="#总结-后记" aria-hidden="true">#</a> 总结 &amp; 后记</h1>
