<template><div><p><img src="pictures/2.png" alt=""></p>
...
<p><img src="pictures/16-01.png" alt="img"></p>
...
<p><img src="pictures/16-02.png" alt="img"></p>
...
<p><img src="pictures/object-class-20230410094307.png" alt="img"></p>
...
<p><img src="pictures/image-20230615212720005.png" alt="image-20230615212720005"></p>
<p><img src="pictures/image-20230615212731031.png" alt="image-20230615212731031"></p>
<p><img src="pictures/image-20230615212738450.png" alt="image-20230615212738450"></p>
<p><img src="pictures/image-20230615212754509.png" alt="image-20230615212754509"></p>
<p>继承是java面向对象编程技术的一块基石，因为它允许创建分等级层次的类。</p>
<p>继承就是子类继承父类的特征和行为，使得子类对象（实例）具有父类的实例域和方法，或子类从父类继承方法，使得子类具有父类相同的行为。</p>
<p>生活中的继承：</p>
<p><img src="pictures/14B0951E-FC75-47A3-B611-4E1883887339.jpg" alt="img"></p>
...
<p><img src="pictures/extends-bigsai-eeee7ea3-30d5-4bb1-9c9d-5e3bf427e805.png" alt="img"></p>
...
<p><img src="pictures/extends-bigsai-ab4c9fef-63be-4bba-a871-7e5fb9bf711a.png" alt="img"></p>
<p>要注意的是，java是不支持多继承的，至于为什么不支持多继承呢，我们来看一下解释。</p>
<p>下面我们来看这个菱型继承</p>
<p>假设我们有类B和类C，它们都继承了相同的类A。另外我们还有类D，类D通过多重继承机制继承了类B和类C。</p>
<p><img src="pictures/16145019571199.jpg" alt="img">￼</p>
...
<p><img src="pictures/extends-bigsai-d3789496-09f8-4a62-8424-e5c45e224320.png" alt="img"></p>
...
<p><img src="pictures/extends-bigsai-c06ece50-32e5-4b03-a31b-05ef03592d0c.png" alt="img"></p>
<p><img src="pictures/image-20230615213114814.png" alt="image-20230615213114814"></p>
<p>下面来一个图，让你快速区分这个继承的分类</p>
<p><img src="pictures/java-extends-2020-12-08.png" alt="img"></p>
...
<p><img src="pictures/extends-bigsai-2ba4864f-af39-4bd7-b59c-db53ec1c38f6.png" alt="img"></p>
...
<p><img src="pictures/extends-bigsai-32bdceb5-e838-47cb-ad96-b7453abae6a5.png" alt="img"></p>
<p>说了这么多我们来看一个继承的练习</p>
<h3 id="练习" tabindex="-1"><a class="header-anchor" href="#练习" aria-hidden="true">#</a> 练习</h3>
<p><img src="pictures/image-20230615213708484.png" alt="image-20230615213708484"></p>
<p>首先我们先画一个图</p>
<p><img src="pictures/image-20230615213722540.png" alt="image-20230615213722540"></p>
<p>画出继承关系。画图是从下往上画。</p>
...
<p><img src="pictures/image-20230615214105578.png" alt="image-20230615214105578"></p>
<p>这个简单理解他的应用场景。就是</p>
<p>比如说有一个登录系统。</p>
<p>有三个不同身份的人都需要登录</p>
<p>这个时候。我们登录系统的这个形参。就可以写他父类的person了。</p>
<p><img src="pictures/image-20230615214129380.png" alt="image-20230615214129380"></p>
...
<p><img src="pictures/image-20230615214704491.png" alt="image-20230615214704491"></p>
<p>具体这个怎么理解呢。</p>
<p><img src="pictures/image-20230615214725375.png" alt="image-20230615214725375"></p>
<p>可以这样理解。就是如果子类和父类都有这个变量。那么sout之后。输出的是父类的变量。</p>
<p>运行也看左边。也就是说实际获取的值也是左边的值。</p>
<p>之后看这个方法调用的解释</p>
<p><img src="pictures/image-20230615214738386.png" alt="image-20230615214738386"></p>
...
<p><img src="pictures/image-20230615214802731.png" alt="image-20230615214802731"></p>
<p>但是也不能随便的转换，</p>
<p>就比如还是上边的代码。</p>
<p>你把a转换为cat。</p>
<p>就会报错。为了尽量避免这种情况的发生。</p>
<p>我们可以用if来进行判断类型。</p>
<p>这里就要用到一个instanceof参数<img src="pictures/image-20230615214820668.png" alt="image-20230615214820668"></p>
<p>这也就可以判断a是否是dog类型的。如果是返回true。</p>
<p>如果不是就返回false</p>
<p>因此可以看这个类型转换的一个判断代码</p>
<p><img src="pictures/image-20230615214833736.png" alt="image-20230615214833736"></p>
<p>但是这也有点麻烦。</p>
<p>所以java在jdk14之后提供了新特性。</p>
<p><img src="pictures/image-20230615214844376.png" alt="image-20230615214844376"></p>
...
<p><img src="pictures/extends-bigsai-2bf1876f-0c1c-4e83-8721-e6f48d6451c0.png" alt="img"></p>
...
<p><img src="pictures/image-20230615215501906.png" alt="image-20230615215501906"></p>
<p>之后开始进行代码演示：</p>
<p>先写父类的animal</p>
...
<p><img src="pictures/image-20230615220313407.png" alt="image-20230615220313407"></p>
...
<p><img src="pictures/17-01.png" alt="img"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="pictures/image-20230616155035788.png" alt="image-20230616155035788"></p>
<p>这个看的有一点的难懂。</p>
<p>这个概念和多态的相似还是很多的。</p>
<p><img src="pictures/image-20230616155044664.png" alt="image-20230616155044664"></p>
...
<p><img src="pictures/15539284762449.jpg" alt="img"></p>
...
<p><img src="pictures/15539289530245.jpg" alt="img"></p>
<p>所以，我们说的，Java的平台无关性实现主要作用于以上阶段。如下图所示：</p>
<p><img src="pictures/15539291533175.jpg" alt="img"></p>
...
<p><img src="pictures/15539297082025.jpg" alt="img"></p>
...
<p><img src="pictures/15539303829914.jpg" alt="img"> ps：图中的Class文件中内容为mock内容</p>
...
<p><img src="pictures/Jietu20210627-141259-2.jpg" alt="img"></p>
...
<p><img src="pictures/varables-03.png" alt="img"></p>
...
<p><img src="pictures/native-method-2a6fd1da-8b64-4fe1-bf3b-fbb117774549.png" alt="img"></p>
...
<p><img src="pictures/native-method-41e11e7f-31c1-4611-9b85-63ec211ff31b.png" alt="img"></p>
...
<p><img src="pictures/native-method-0b08bf51-7bd9-4d06-a0dc-4262c1a71fd5.png" alt="img"></p>
<blockquote>
...
<p><img src="pictures/native-method-e5c34f63-84df-4a99-96e1-b45ea04929df.png" alt="img"></p>
...
<p><img src="pictures/native-method-e93c8fa8-6e33-4374-81da-8bd9360d1bb4.png" alt="img"></p>
...
<p><img src="pictures/native-method-34beba0f-8fe8-48d0-aa48-b25c1b504b59.png" alt="img"></p>
...
<p><img src="pictures/native-method-6673cf73-c4dd-4434-b821-0d705f756a73.png" alt="img"></p>
...
<p><img src="pictures/18-01.png" alt="img"></p>
...
<p><img src="pictures/18-02.png" alt="img"></p>
...
<p><img src="pictures/bokeyuan-jianxijavazhongdifangwenquanxiankongzhi-154ae82f-72a5-45fc-ad3c-e1eb575d8572.png" alt="img"></p>
...
<p><img src="pictures/bokeyuan-jianxijavazhongdifangwenquanxiankongzhi-b3e9dc56-53e8-42f1-b8ee-35115edfe7e7.png" alt="img"></p>
...
<p><img src="pictures/bokeyuan-jianxijavazhongdifangwenquanxiankongzhi-b1d4b7ed-fc87-47d4-bdd9-3f6a8ea96100.png" alt="img"></p>
...
<p><img src="pictures/image-20230616180412200.png" alt="image-20230616180412200"></p>
<p>简单的来说就是</p>
<p><img src="pictures/image-20230616180421789.png" alt="image-20230616180421789"></p>
...
<p><img src="pictures/22-01.png" alt="img"></p>
...
<p><img src="pictures/abstract-01.png" alt="img"></p>
...
<p><img src="pictures/abstract-02.png" alt="img"></p>
<p>第二处在尝试定义 abstract 的方法上，提示“抽象方法所在的类不是抽象的”，见下图。</p>
<p><img src="pictures/abstract-03.png" alt="img"></p>
...
<p><img src="pictures/abstract-04.png" alt="img"></p>
...
<p><img src="pictures/abstract-05.png" alt="img"></p>
...
<p><img src="pictures/interface-03.png" alt="img"></p>
<p>“为什么要在接口中定义默认方法呢？”</p>
...
<p><img src="pictures/interface-04.png" alt="img"></p>
...
<p><img src="pictures/interface-05.png" alt="img"></p>
<p><strong>4）接口的抽象方法不能是 private、protected 或者 final</strong>，否则编译器都会报错。</p>
<p><img src="pictures/interface-06.png" alt="img"></p>
...
<p><img src="pictures/interface-07.png" alt="img"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="pictures/image-20230616222707040.png" alt="image-20230616222707040"></p>
...
<p><img src="pictures/image-20230616222313161.png" alt="image-20230616222313161"></p>
<p>首先我们话一个图帮助我们来理解</p>
<p><img src="pictures/image-20230616222323833.png" alt="image-20230616222323833"></p>
<p>之后开始我们的代码实现吧。</p>
<p>先看父类</p>
...
<p><img src="pictures/image-20230616222514213.png" alt="image-20230616222514213"></p>
...
<p><img src="pictures/image-20230616222830270.png" alt="image-20230616222830270"></p>
<p><img src="pictures/image-20230616222844663.png" alt="image-20230616222844663"></p>
<p><img src="pictures/image-20230616222853446.png" alt="image-20230616222853446"></p>
...
<p><img src="pictures/inner-class-26fc0242-134a-4588-a52d-7da962fc3fb9.png" alt="img"></p>
...
<p><img src="pictures/inner-class-c0b9bdf5-cb12-45fc-b362-cb14d5d44fdc.png" alt="img"></p>
...
<p><img src="pictures/inner-class-69523196-37fe-43c6-a52e-5a8c94fdd2d8.png" alt="img"></p>
...
<p><img src="pictures/20-01.png" alt="img"></p>
