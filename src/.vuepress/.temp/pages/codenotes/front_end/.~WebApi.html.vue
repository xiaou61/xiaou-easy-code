<template><div><h1 id="canvas-api" tabindex="-1"><a class="header-anchor" href="#canvas-api" aria-hidden="true">#</a> Canvas API</h1>
...
<h2 id="canvas-api-绘制图形" tabindex="-1"><a class="header-anchor" href="#canvas-api-绘制图形" aria-hidden="true">#</a> Canvas API：绘制图形</h2>
...
<h3 id="线型" tabindex="-1"><a class="header-anchor" href="#线型" aria-hidden="true">#</a> 线型</h3>
...
<h3 id="弧线" tabindex="-1"><a class="header-anchor" href="#弧线" aria-hidden="true">#</a> 弧线</h3>
<p>以下方法用于绘制弧形。</p>
<ul>
...
<h3 id="渐变色和图像填充" tabindex="-1"><a class="header-anchor" href="#渐变色和图像填充" aria-hidden="true">#</a> 渐变色和图像填充</h3>
...
<h3 id="阴影" tabindex="-1"><a class="header-anchor" href="#阴影" aria-hidden="true">#</a> 阴影</h3>
<p>以下属性用于设置阴影。</p>
<ul>
...
ctx<span class="token punctuation">.</span>fillStyle <span class="token operator">=</span> <span class="token string">'green'</span><span class="token punctuation">;</span>
ctx<span class="token punctuation">.</span><span class="token function">fillRect</span><span class="token punctuation">(</span><span class="token number">10</span><span class="token punctuation">,</span> <span class="token number">10</span><span class="token punctuation">,</span> <span class="token number">100</span><span class="token punctuation">,</span> <span class="token number">100</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="canvas-api-图像处理" tabindex="-1"><a class="header-anchor" href="#canvas-api-图像处理" aria-hidden="true">#</a> Canvas API：图像处理</h2>
<h3 id="canvasrenderingcontext2d-drawimage" tabindex="-1"><a class="header-anchor" href="#canvasrenderingcontext2d-drawimage" aria-hidden="true">#</a> CanvasRenderingContext2D.drawImage()</h3>
...
<h3 id="像素读写" tabindex="-1"><a class="header-anchor" href="#像素读写" aria-hidden="true">#</a> 像素读写</h3>
<p>以下三个方法与像素读写相关。</p>
<ul>
...
<h3 id="canvasrenderingcontext2d-save-canvasrenderingcontext2d-restore" tabindex="-1"><a class="header-anchor" href="#canvasrenderingcontext2d-save-canvasrenderingcontext2d-restore" aria-hidden="true">#</a> CanvasRenderingContext2D.save()，CanvasRenderingContext2D.restore()</h3>
...
<h3 id="canvasrenderingcontext2d-canvas" tabindex="-1"><a class="header-anchor" href="#canvasrenderingcontext2d-canvas" aria-hidden="true">#</a> CanvasRenderingContext2D.canvas</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="图像变换" tabindex="-1"><a class="header-anchor" href="#图像变换" aria-hidden="true">#</a> 图像变换</h3>
<p>以下方法用于图像变换。</p>
<ul>
...
<h2 id="canvas-元素的方法" tabindex="-1"><a class="header-anchor" href="#canvas-元素的方法" aria-hidden="true">#</a> <code v-pre>&lt;canvas&gt;</code> 元素的方法</h2>
<p>除了<code v-pre>CanvasRenderingContext2D</code>对象提供的方法，<code v-pre>&lt;canvas&gt;</code>元素本身也有自己的方法。</p>
<h3 id="htmlcanvaselement-todataurl" tabindex="-1"><a class="header-anchor" href="#htmlcanvaselement-todataurl" aria-hidden="true">#</a> HTMLCanvasElement.toDataURL()</h3>
...
<h3 id="htmlcanvaselement-toblob" tabindex="-1"><a class="header-anchor" href="#htmlcanvaselement-toblob" aria-hidden="true">#</a> HTMLCanvasElement.toBlob()</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="canvas-使用实例" tabindex="-1"><a class="header-anchor" href="#canvas-使用实例" aria-hidden="true">#</a> Canvas 使用实例</h2>
<h3 id="动画效果" tabindex="-1"><a class="header-anchor" href="#动画效果" aria-hidden="true">#</a> 动画效果</h3>
...
<h3 id="像素处理" tabindex="-1"><a class="header-anchor" href="#像素处理" aria-hidden="true">#</a> 像素处理</h3>
...
<h1 id="剪贴板操作-clipboard-api-教程" tabindex="-1"><a class="header-anchor" href="#剪贴板操作-clipboard-api-教程" aria-hidden="true">#</a> 剪贴板操作 Clipboard API 教程</h1>
...
<p>本文逐一介绍这三种方法。</p>
<h2 id="document-execcommand-方法" tabindex="-1"><a class="header-anchor" href="#document-execcommand-方法" aria-hidden="true">#</a> Document.execCommand() 方法</h2>
...
<h2 id="异步-clipboard-api" tabindex="-1"><a class="header-anchor" href="#异步-clipboard-api" aria-hidden="true">#</a> 异步 Clipboard API</h2>
...
<p><img src="images/bg2021012004.jpg" alt=""></p>
...
<h2 id="clipboard-对象" tabindex="-1"><a class="header-anchor" href="#clipboard-对象" aria-hidden="true">#</a> Clipboard 对象</h2>
<p>Clipboard 对象提供了四个方法，用来读写剪贴板。它们都是异步方法，返回 Promise 对象。</p>
<h3 id="clipboard-readtext" tabindex="-1"><a class="header-anchor" href="#clipboard-readtext" aria-hidden="true">#</a> Clipboard.readText()</h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token function">getClipboardContents</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="clipboard-read" tabindex="-1"><a class="header-anchor" href="#clipboard-read" aria-hidden="true">#</a> Clipboard.read()</h3>
...
<h3 id="clipboard-writetext" tabindex="-1"><a class="header-anchor" href="#clipboard-writetext" aria-hidden="true">#</a> Clipboard.writeText()</h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token function">copyPageUrl</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="clipboard-write" tabindex="-1"><a class="header-anchor" href="#clipboard-write" aria-hidden="true">#</a> Clipboard.write()</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="copy-事件-cut-事件" tabindex="-1"><a class="header-anchor" href="#copy-事件-cut-事件" aria-hidden="true">#</a> copy 事件，cut 事件</h2>
...
<h2 id="paste-事件" tabindex="-1"><a class="header-anchor" href="#paste-事件" aria-hidden="true">#</a> paste 事件</h2>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考链接-1" tabindex="-1"><a class="header-anchor" href="#参考链接-1" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="fetch-api-教程" tabindex="-1"><a class="header-anchor" href="#fetch-api-教程" aria-hidden="true">#</a> Fetch API 教程</h1>
...
<h2 id="response-对象-处理-http-回应" tabindex="-1"><a class="header-anchor" href="#response-对象-处理-http-回应" aria-hidden="true">#</a> Response 对象：处理 HTTP 回应</h2>
<h3 id="response-对象的同步属性" tabindex="-1"><a class="header-anchor" href="#response-对象的同步属性" aria-hidden="true">#</a> Response 对象的同步属性</h3>
...
<h3 id="判断请求是否成功" tabindex="-1"><a class="header-anchor" href="#判断请求是否成功" aria-hidden="true">#</a> 判断请求是否成功</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="response-headers-属性" tabindex="-1"><a class="header-anchor" href="#response-headers-属性" aria-hidden="true">#</a> Response.headers 属性</h3>
...
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="读取内容的方法" tabindex="-1"><a class="header-anchor" href="#读取内容的方法" aria-hidden="true">#</a> 读取内容的方法</h3>
...
<h3 id="response-clone" tabindex="-1"><a class="header-anchor" href="#response-clone" aria-hidden="true">#</a> Response.clone()</h3>
...
<h3 id="response-body-属性" tabindex="-1"><a class="header-anchor" href="#response-body-属性" aria-hidden="true">#</a> Response.body 属性</h3>
...
<h2 id="fetch-的第二个参数-定制-http-请求" tabindex="-1"><a class="header-anchor" href="#fetch-的第二个参数-定制-http-请求" aria-hidden="true">#</a> <code v-pre>fetch()</code>的第二个参数：定制 HTTP 请求</h2>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="fetch-配置对象的完整-api" tabindex="-1"><a class="header-anchor" href="#fetch-配置对象的完整-api" aria-hidden="true">#</a> <code v-pre>fetch()</code>配置对象的完整 API</h2>
...
<h2 id="取消fetch-请求" tabindex="-1"><a class="header-anchor" href="#取消fetch-请求" aria-hidden="true">#</a> 取消<code v-pre>fetch()</code>请求</h2>
...
<span class="token punctuation">}</span> <span class="token keyword">catch</span><span class="token punctuation">(</span>err<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考链接-2" tabindex="-1"><a class="header-anchor" href="#参考链接-2" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="fontface-api" tabindex="-1"><a class="header-anchor" href="#fontface-api" aria-hidden="true">#</a> FontFace API</h1>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="geolocation-api" tabindex="-1"><a class="header-anchor" href="#geolocation-api" aria-hidden="true">#</a> Geolocation API</h1>
...
<h2 id="geolocation-对象" tabindex="-1"><a class="header-anchor" href="#geolocation-对象" aria-hidden="true">#</a> Geolocation 对象</h2>
...
<h3 id="geolocation-getcurrentposition" tabindex="-1"><a class="header-anchor" href="#geolocation-getcurrentposition" aria-hidden="true">#</a> Geolocation.getCurrentPosition()</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="geolocation-watchposition" tabindex="-1"><a class="header-anchor" href="#geolocation-watchposition" aria-hidden="true">#</a> Geolocation.watchPosition()</h3>
...
<h2 id="coordinates-对象" tabindex="-1"><a class="header-anchor" href="#coordinates-对象" aria-hidden="true">#</a> Coordinates 对象</h2>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考链接-3" tabindex="-1"><a class="header-anchor" href="#参考链接-3" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="intersectionobserver" tabindex="-1"><a class="header-anchor" href="#intersectionobserver" aria-hidden="true">#</a> IntersectionObserver</h1>
<p>网页开发时，常常需要了解某个元素是否进入了“视口”（viewport），即用户能不能看到它。</p>
<p><img src="images/bg2016110201.gif" alt=""></p>
...
<h2 id="intersectionobserver-observe" tabindex="-1"><a class="header-anchor" href="#intersectionobserver-observe" aria-hidden="true">#</a> IntersectionObserver.observe()</h2>
...
<h3 id="callback-参数" tabindex="-1"><a class="header-anchor" href="#callback-参数" aria-hidden="true">#</a> callback 参数</h3>
...
<h3 id="intersectionobserverentry-对象" tabindex="-1"><a class="header-anchor" href="#intersectionobserverentry-对象" aria-hidden="true">#</a> IntersectionObserverEntry 对象</h3>
...
<p><img src="images/bg2016110202.png" alt=""></p>
...
<h3 id="option-对象" tabindex="-1"><a class="header-anchor" href="#option-对象" aria-hidden="true">#</a> Option 对象</h3>
...
<p><img src="images/bg2016110202.gif" alt=""></p>
...
<h3 id="惰性加载-lazy-load" tabindex="-1"><a class="header-anchor" href="#惰性加载-lazy-load" aria-hidden="true">#</a> 惰性加载（lazy load）</h3>
...
<h3 id="无限滚动" tabindex="-1"><a class="header-anchor" href="#无限滚动" aria-hidden="true">#</a> 无限滚动</h3>
...
<h3 id="视频自动播放" tabindex="-1"><a class="header-anchor" href="#视频自动播放" aria-hidden="true">#</a> 视频自动播放</h3>
...
<h2 id="参考链接-4" tabindex="-1"><a class="header-anchor" href="#参考链接-4" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="intl-relativetimeformat" tabindex="-1"><a class="header-anchor" href="#intl-relativetimeformat" aria-hidden="true">#</a> Intl.RelativeTimeFormat</h1>
...
<h2 id="基本用法-1" tabindex="-1"><a class="header-anchor" href="#基本用法-1" aria-hidden="true">#</a> 基本用法</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="intl-relativetimeformat-prototype-format" tabindex="-1"><a class="header-anchor" href="#intl-relativetimeformat-prototype-format" aria-hidden="true">#</a> Intl.RelativeTimeFormat.prototype.format()</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="intl-relativetimeformat-prototype-formattoparts" tabindex="-1"><a class="header-anchor" href="#intl-relativetimeformat-prototype-formattoparts" aria-hidden="true">#</a> Intl.RelativeTimeFormat.prototype.formatToParts()</h2>
...
<h2 id="参考链接-5" tabindex="-1"><a class="header-anchor" href="#参考链接-5" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="offline-应用" tabindex="-1"><a class="header-anchor" href="#offline-应用" aria-hidden="true">#</a> Offline 应用</h1>
...
<h1 id="page-lifecycle-api" tabindex="-1"><a class="header-anchor" href="#page-lifecycle-api" aria-hidden="true">#</a> Page Lifecycle API</h1>
...
<h2 id="生命周期阶段" tabindex="-1"><a class="header-anchor" href="#生命周期阶段" aria-hidden="true">#</a> 生命周期阶段</h2>
<p>网页的生命周期分成六个阶段，每个时刻只可能处于其中一个阶段。</p>
<p><img src="images/bg2018110401.png" alt=""></p>
...
<h2 id="常见场景" tabindex="-1"><a class="header-anchor" href="#常见场景" aria-hidden="true">#</a> 常见场景</h2>
...
<h3 id="focus-事件" tabindex="-1"><a class="header-anchor" href="#focus-事件" aria-hidden="true">#</a> focus 事件</h3>
<p><code v-pre>focus</code>事件在页面获得输入焦点时触发，比如网页从 Passive 阶段变为 Active 阶段。</p>
<h3 id="blur-事件" tabindex="-1"><a class="header-anchor" href="#blur-事件" aria-hidden="true">#</a> blur 事件</h3>
<p><code v-pre>blur</code>事件在页面失去输入焦点时触发，比如网页从 Active 阶段变为 Passive 阶段。</p>
<h3 id="visibilitychange-事件" tabindex="-1"><a class="header-anchor" href="#visibilitychange-事件" aria-hidden="true">#</a> visibilitychange 事件</h3>
...
<h3 id="freeze-事件" tabindex="-1"><a class="header-anchor" href="#freeze-事件" aria-hidden="true">#</a> freeze 事件</h3>
...
<h3 id="resume-事件" tabindex="-1"><a class="header-anchor" href="#resume-事件" aria-hidden="true">#</a> resume 事件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="pageshow-事件" tabindex="-1"><a class="header-anchor" href="#pageshow-事件" aria-hidden="true">#</a> pageshow 事件</h3>
...
<h3 id="pagehide-事件" tabindex="-1"><a class="header-anchor" href="#pagehide-事件" aria-hidden="true">#</a> pagehide 事件</h3>
...
<h3 id="beforeunload-事件" tabindex="-1"><a class="header-anchor" href="#beforeunload-事件" aria-hidden="true">#</a> beforeunload 事件</h3>
<p><code v-pre>beforeunload</code>事件在窗口或文档即将卸载时触发。该事件发生时，文档仍然可见，此时卸载仍可取消。经过这个事件，网页进入 Terminated 状态。</p>
<h3 id="unload-事件" tabindex="-1"><a class="header-anchor" href="#unload-事件" aria-hidden="true">#</a> unload 事件</h3>
<p><code v-pre>unload</code>事件在页面正在卸载时触发。经过这个事件，网页进入 Terminated 状态。</p>
<h2 id="获取当前阶段" tabindex="-1"><a class="header-anchor" href="#获取当前阶段" aria-hidden="true">#</a> 获取当前阶段</h2>
...
<h2 id="document-wasdiscarded" tabindex="-1"><a class="header-anchor" href="#document-wasdiscarded" aria-hidden="true">#</a> document.wasDiscarded</h2>
...
<h2 id="参考链接-6" tabindex="-1"><a class="header-anchor" href="#参考链接-6" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="page-visibility-api" tabindex="-1"><a class="header-anchor" href="#page-visibility-api" aria-hidden="true">#</a> Page Visibility API</h1>
...
<h2 id="document-visibilitystate" tabindex="-1"><a class="header-anchor" href="#document-visibilitystate" aria-hidden="true">#</a> document.visibilityState</h2>
...
<h2 id="document-hidden" tabindex="-1"><a class="header-anchor" href="#document-hidden" aria-hidden="true">#</a> document.hidden</h2>
...
<h2 id="visibilitychange-事件-1" tabindex="-1"><a class="header-anchor" href="#visibilitychange-事件-1" aria-hidden="true">#</a> visibilitychange 事件</h2>
...
<span class="token keyword">function</span> <span class="token function">startStopVideo</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="页面卸载" tabindex="-1"><a class="header-anchor" href="#页面卸载" aria-hidden="true">#</a> 页面卸载</h2>
...
<h2 id="参考链接-7" tabindex="-1"><a class="header-anchor" href="#参考链接-7" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="point-lock-api" tabindex="-1"><a class="header-anchor" href="#point-lock-api" aria-hidden="true">#</a> Point lock API</h1>
<p>不用释放按钮，就锁定鼠标。</p>
...
<h1 id="server-sent-events" tabindex="-1"><a class="header-anchor" href="#server-sent-events" aria-hidden="true">#</a> Server-Sent Events</h1>
<h2 id="简介-3" tabindex="-1"><a class="header-anchor" href="#简介-3" aria-hidden="true">#</a> 简介</h2>
...
<h2 id="与-websocket-的比较" tabindex="-1"><a class="header-anchor" href="#与-websocket-的比较" aria-hidden="true">#</a> 与 WebSocket 的比较</h2>
...
<h2 id="客户端-api" tabindex="-1"><a class="header-anchor" href="#客户端-api" aria-hidden="true">#</a> 客户端 API</h2>
<h3 id="eventsource-对象" tabindex="-1"><a class="header-anchor" href="#eventsource-对象" aria-hidden="true">#</a> EventSource 对象</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="readystate-属性" tabindex="-1"><a class="header-anchor" href="#readystate-属性" aria-hidden="true">#</a> readyState 属性</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="url-属性" tabindex="-1"><a class="header-anchor" href="#url-属性" aria-hidden="true">#</a> url 属性</h3>
<p><code v-pre>EventSource</code>实例的<code v-pre>url</code>属性返回连接的网址，该属性只读。</p>
<h3 id="withcredentials-属性" tabindex="-1"><a class="header-anchor" href="#withcredentials-属性" aria-hidden="true">#</a> withCredentials 属性</h3>
...
<h3 id="onopen-属性" tabindex="-1"><a class="header-anchor" href="#onopen-属性" aria-hidden="true">#</a> onopen 属性</h3>
...
<h3 id="onerror-属性" tabindex="-1"><a class="header-anchor" href="#onerror-属性" aria-hidden="true">#</a> onerror 属性</h3>
...
source<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'error'</span><span class="token punctuation">,</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">event</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token comment">// handle error event</span>
<span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token boolean">false</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="自定义事件" tabindex="-1"><a class="header-anchor" href="#自定义事件" aria-hidden="true">#</a> 自定义事件</h3>
...
<h3 id="close-方法" tabindex="-1"><a class="header-anchor" href="#close-方法" aria-hidden="true">#</a> close() 方法</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="服务器实现" tabindex="-1"><a class="header-anchor" href="#服务器实现" aria-hidden="true">#</a> 服务器实现</h2>
...
data: with two lines \n\n
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="data-字段" tabindex="-1"><a class="header-anchor" href="#data-字段" aria-hidden="true">#</a> data 字段</h3>
...
data: "baz", 555\n
data: }\n\n
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="id-字段" tabindex="-1"><a class="header-anchor" href="#id-字段" aria-hidden="true">#</a> id 字段</h3>
...
<h3 id="event-字段" tabindex="-1"><a class="header-anchor" href="#event-字段" aria-hidden="true">#</a> event 字段</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="retry-字段" tabindex="-1"><a class="header-anchor" href="#retry-字段" aria-hidden="true">#</a> retry 字段</h3>
...
<h2 id="node-服务器实例" tabindex="-1"><a class="header-anchor" href="#node-服务器实例" aria-hidden="true">#</a> Node 服务器实例</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考链接-8" tabindex="-1"><a class="header-anchor" href="#参考链接-8" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="service-worker" tabindex="-1"><a class="header-anchor" href="#service-worker" aria-hidden="true">#</a> Service Worker</h1>
...
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>self<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'install'</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">event</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="激活" tabindex="-1"><a class="header-anchor" href="#激活" aria-hidden="true">#</a> 激活</h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>self<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'activate'</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">event</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="service-worker-与网页的通信" tabindex="-1"><a class="header-anchor" href="#service-worker-与网页的通信" aria-hidden="true">#</a> Service Worker 与网页的通信</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>self<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'activate'</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">event</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
    event<span class="token punctuation">.</span><span class="token function">waitUntil</span><span class="token punctuation">(</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'message'</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">data</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考链接-9" tabindex="-1"><a class="header-anchor" href="#参考链接-9" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="svg-图像" tabindex="-1"><a class="header-anchor" href="#svg-图像" aria-hidden="true">#</a> SVG 图像</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h2>
<h3 id="svg-标签" tabindex="-1"><a class="header-anchor" href="#svg-标签" aria-hidden="true">#</a> <code v-pre>&lt;svg&gt;</code>标签</h3>
...
<h3 id="circle-标签" tabindex="-1"><a class="header-anchor" href="#circle-标签" aria-hidden="true">#</a> <code v-pre>&lt;circle&gt;</code>标签</h3>
...
<h3 id="line-标签" tabindex="-1"><a class="header-anchor" href="#line-标签" aria-hidden="true">#</a> <code v-pre>&lt;line&gt;</code>标签</h3>
...
<h3 id="polyline-标签" tabindex="-1"><a class="header-anchor" href="#polyline-标签" aria-hidden="true">#</a> <code v-pre>&lt;polyline&gt;</code>标签</h3>
...
<h3 id="rect-标签" tabindex="-1"><a class="header-anchor" href="#rect-标签" aria-hidden="true">#</a> <code v-pre>&lt;rect&gt;</code>标签</h3>
...
<h3 id="ellipse-标签" tabindex="-1"><a class="header-anchor" href="#ellipse-标签" aria-hidden="true">#</a> <code v-pre>&lt;ellipse&gt;</code>标签</h3>
...
<h3 id="polygon-标签" tabindex="-1"><a class="header-anchor" href="#polygon-标签" aria-hidden="true">#</a> <code v-pre>&lt;polygon&gt;</code>标签</h3>
...
<h3 id="path-标签" tabindex="-1"><a class="header-anchor" href="#path-标签" aria-hidden="true">#</a> <code v-pre>&lt;path&gt;</code>标签</h3>
...
<h3 id="text-标签" tabindex="-1"><a class="header-anchor" href="#text-标签" aria-hidden="true">#</a> <code v-pre>&lt;text&gt;</code>标签</h3>
...
<h3 id="use-标签" tabindex="-1"><a class="header-anchor" href="#use-标签" aria-hidden="true">#</a> <code v-pre>&lt;use&gt;</code>标签</h3>
...
<h3 id="g-标签" tabindex="-1"><a class="header-anchor" href="#g-标签" aria-hidden="true">#</a> <code v-pre>&lt;g&gt;</code>标签</h3>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>svg</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="defs-标签" tabindex="-1"><a class="header-anchor" href="#defs-标签" aria-hidden="true">#</a> <code v-pre>&lt;defs&gt;</code>标签</h3>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>svg</span> <span class="token attr-name">width</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>300<span class="token punctuation">"</span></span> <span class="token attr-name">height</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>100<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>use</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>#myCircle<span class="token punctuation">"</span></span> <span class="token attr-name">x</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>200<span class="token punctuation">"</span></span> <span class="token attr-name">y</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>0<span class="token punctuation">"</span></span> <span class="token attr-name">fill</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>white<span class="token punctuation">"</span></span> <span class="token attr-name">stroke</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>blue<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>svg</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="pattern-标签" tabindex="-1"><a class="header-anchor" href="#pattern-标签" aria-hidden="true">#</a> <code v-pre>&lt;pattern&gt;</code>标签</h3>
...
<h3 id="image-标签" tabindex="-1"><a class="header-anchor" href="#image-标签" aria-hidden="true">#</a> <code v-pre>&lt;image&gt;</code>标签</h3>
...
<h3 id="animate-标签" tabindex="-1"><a class="header-anchor" href="#animate-标签" aria-hidden="true">#</a> <code v-pre>&lt;animate&gt;</code>标签</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="animatetransform-标签" tabindex="-1"><a class="header-anchor" href="#animatetransform-标签" aria-hidden="true">#</a> <code v-pre>&lt;animateTransform&gt;</code>标签</h3>
...
<h2 id="javascript-操作" tabindex="-1"><a class="header-anchor" href="#javascript-操作" aria-hidden="true">#</a> JavaScript 操作</h2>
<h3 id="dom-操作" tabindex="-1"><a class="header-anchor" href="#dom-操作" aria-hidden="true">#</a> DOM 操作</h3>
...
<h3 id="获取-svg-dom" tabindex="-1"><a class="header-anchor" href="#获取-svg-dom" aria-hidden="true">#</a> 获取 SVG DOM</h3>
...
<h3 id="读取-svg-源码" tabindex="-1"><a class="header-anchor" href="#读取-svg-源码" aria-hidden="true">#</a> 读取 SVG 源码</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="svg-图像转为-canvas-图像" tabindex="-1"><a class="header-anchor" href="#svg-图像转为-canvas-图像" aria-hidden="true">#</a> SVG 图像转为 Canvas 图像</h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>img<span class="token punctuation">.</span><span class="token function-variable function">onload</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  ctx<span class="token punctuation">.</span><span class="token function">drawImage</span><span class="token punctuation">(</span>img<span class="token punctuation">,</span> <span class="token number">0</span><span class="token punctuation">,</span> <span class="token number">0</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="实例-折线图" tabindex="-1"><a class="header-anchor" href="#实例-折线图" aria-hidden="true">#</a> 实例：折线图</h2>
<p>下面将一张数据表格画成折线图。</p>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>svg</span> <span class="token attr-name">width</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>350<span class="token punctuation">"</span></span> <span class="token attr-name">height</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>160<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>g</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>svg</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考链接-10" tabindex="-1"><a class="header-anchor" href="#参考链接-10" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="web-share-api" tabindex="-1"><a class="header-anchor" href="#web-share-api" aria-hidden="true">#</a> Web Share API</h1>
...
<h2 id="接口细节" tabindex="-1"><a class="header-anchor" href="#接口细节" aria-hidden="true">#</a> 接口细节</h2>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>shareButton<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'click'</span><span class="token punctuation">,</span> <span class="token keyword">async</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="分享文件" tabindex="-1"><a class="header-anchor" href="#分享文件" aria-hidden="true">#</a> 分享文件</h2>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考链接-11" tabindex="-1"><a class="header-anchor" href="#参考链接-11" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h1 id="web-audio-api" tabindex="-1"><a class="header-anchor" href="#web-audio-api" aria-hidden="true">#</a> Web Audio API</h1>
<p>Web Audio API 用于操作声音。这个 API 可以让网页发出声音。</p>
<h2 id="基本用法-2" tabindex="-1"><a class="header-anchor" href="#基本用法-2" aria-hidden="true">#</a> 基本用法</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="过滤器" tabindex="-1"><a class="header-anchor" href="#过滤器" aria-hidden="true">#</a> 过滤器</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="web-components" tabindex="-1"><a class="header-anchor" href="#web-components" aria-hidden="true">#</a> Web Components</h1>
...
<h2 id="custom-element" tabindex="-1"><a class="header-anchor" href="#custom-element" aria-hidden="true">#</a> Custom Element</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="生命周期方法" tabindex="-1"><a class="header-anchor" href="#生命周期方法" aria-hidden="true">#</a> 生命周期方法</h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">MyElement</span> <span class="token keyword">extends</span> <span class="token class-name">HTMLElement</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="自定义属性和方法" tabindex="-1"><a class="header-anchor" href="#自定义属性和方法" aria-hidden="true">#</a> 自定义属性和方法</h3>
...
<h3 id="window-customelements-whendefined" tabindex="-1"><a class="header-anchor" href="#window-customelements-whendefined" aria-hidden="true">#</a> window.customElements.whenDefined()</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="custom-element-的子元素" tabindex="-1"><a class="header-anchor" href="#custom-element-的子元素" aria-hidden="true">#</a> Custom Element 的子元素</h3>
...
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>container<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="template-标签" tabindex="-1"><a class="header-anchor" href="#template-标签" aria-hidden="true">#</a> <code v-pre>&lt;template&gt;</code>标签</h2>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="document-importnode" tabindex="-1"><a class="header-anchor" href="#document-importnode" aria-hidden="true">#</a> document.importNode()</h3>
...
<h2 id="shadow-dom" tabindex="-1"><a class="header-anchor" href="#shadow-dom" aria-hidden="true">#</a> Shadow DOM</h2>
...
<h2 id="html-import" tabindex="-1"><a class="header-anchor" href="#html-import" aria-hidden="true">#</a> HTML Import</h2>
...
<h3 id="脚本的执行" tabindex="-1"><a class="header-anchor" href="#脚本的执行" aria-hidden="true">#</a> 脚本的执行</h3>
...
<h3 id="web-component的封装" tabindex="-1"><a class="header-anchor" href="#web-component的封装" aria-hidden="true">#</a> Web Component的封装</h3>
...
<h2 id="polymer-js" tabindex="-1"><a class="header-anchor" href="#polymer-js" aria-hidden="true">#</a> Polymer.js</h2>
...
<h3 id="直接使用的组件" tabindex="-1"><a class="header-anchor" href="#直接使用的组件" aria-hidden="true">#</a> 直接使用的组件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装-1" tabindex="-1"><a class="header-anchor" href="#安装-1" aria-hidden="true">#</a> 安装</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="自定义组件" tabindex="-1"><a class="header-anchor" href="#自定义组件" aria-hidden="true">#</a> 自定义组件</h3>
...
<h3 id="组件的使用方法" tabindex="-1"><a class="header-anchor" href="#组件的使用方法" aria-hidden="true">#</a> 组件的使用方法</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考链接-12" tabindex="-1"><a class="header-anchor" href="#参考链接-12" aria-hidden="true">#</a> 参考链接</h2>
<ul>
...
<h2 id="简介-5" tabindex="-1"><a class="header-anchor" href="#简介-5" aria-hidden="true">#</a> 简介</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="websocket-握手" tabindex="-1"><a class="header-anchor" href="#websocket-握手" aria-hidden="true">#</a> WebSocket 握手</h2>
...
<h2 id="客户端的简单示例" tabindex="-1"><a class="header-anchor" href="#客户端的简单示例" aria-hidden="true">#</a> 客户端的简单示例</h2>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="客户端-api-1" tabindex="-1"><a class="header-anchor" href="#客户端-api-1" aria-hidden="true">#</a> 客户端 API</h2>
...
<h3 id="构造函数-websocket" tabindex="-1"><a class="header-anchor" href="#构造函数-websocket" aria-hidden="true">#</a> 构造函数 WebSocket</h3>
...
<h3 id="websocket-readystate" tabindex="-1"><a class="header-anchor" href="#websocket-readystate" aria-hidden="true">#</a> webSocket.readyState</h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">switch</span> <span class="token punctuation">(</span>ws<span class="token punctuation">.</span>readyState<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">default</span><span class="token operator">:</span>
    ...
    <span class="token keyword">break</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="websocket-onopen" tabindex="-1"><a class="header-anchor" href="#websocket-onopen" aria-hidden="true">#</a> webSocket.onopen</h3>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>ws<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'open'</span><span class="token punctuation">,</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">event</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ws<span class="token punctuation">.</span><span class="token function">send</span><span class="token punctuation">(</span><span class="token string">'Hello Server!'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="websocket-onclose" tabindex="-1"><a class="header-anchor" href="#websocket-onclose" aria-hidden="true">#</a> webSocket.onclose</h3>
...
ws<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">"close"</span><span class="token punctuation">,</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">event</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">// handle close event</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="websocket-onmessage" tabindex="-1"><a class="header-anchor" href="#websocket-onmessage" aria-hidden="true">#</a> webSocket.onmessage</h3>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="websocket-send" tabindex="-1"><a class="header-anchor" href="#websocket-send" aria-hidden="true">#</a> webSocket.send()</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="websocket-onerror" tabindex="-1"><a class="header-anchor" href="#websocket-onerror" aria-hidden="true">#</a> webSocket.onerror</h3>
...
socket<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">"error"</span><span class="token punctuation">,</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">event</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token comment">// handle error event</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="websocket-服务器" tabindex="-1"><a class="header-anchor" href="#websocket-服务器" aria-hidden="true">#</a> WebSocket 服务器</h2>
...
<h2 id="参考链接-13" tabindex="-1"><a class="header-anchor" href="#参考链接-13" aria-hidden="true">#</a> 参考链接</h2>
<ul>
