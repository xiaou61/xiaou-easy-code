...
![img](/images/Java/16145019571199.jpg)￼
...
![img](/images/Java/Jietu20210627-141259-2.jpg)
...
![img](/images/Java/varables-03.png)
...
![img](/images/Java/native-method-2a6fd1da-8b64-4fe1-bf3b-fbb117774549.png)
...
![img](/images/Java/native-method-41e11e7f-31c1-4611-9b85-63ec211ff31b.png)

##### 03）使用 `javah -jni HelloJNI` 生成扩展名为 h 的头文件

![img](/images/Java/native-method-0b08bf51-7bd9-4d06-a0dc-4262c1a71fd5.png)
...
![img](/images/Java/native-method-e5c34f63-84df-4a99-96e1-b45ea04929df.png)
...
![img](/images/Java/native-method-e93c8fa8-6e33-4374-81da-8bd9360d1bb4.png)

##### 07）运行 HelloJNI

执行`java HelloJNI`命令运行 HelloJNI，如果一切正常，就会在终端上输出 Hello, JNI!。

![img](/images/Java/native-method-34beba0f-8fe8-48d0-aa48-b25c1b504b59.png)

#### **3、JNI 调用 C 的流程图**

![img](/images/Java/native-method-6673cf73-c4dd-4434-b821-0d705f756a73.png)
...
![img](/images/Java/bokeyuan-jianxijavazhongdifangwenquanxiankongzhi-154ae82f-72a5-45fc-ad3c-e1eb575d8572.png)
...
![img](/images/Java/bokeyuan-jianxijavazhongdifangwenquanxiankongzhi-b3e9dc56-53e8-42f1-b8ee-35115edfe7e7.png)
...
![img](/images/Java/bokeyuan-jianxijavazhongdifangwenquanxiankongzhi-b1d4b7ed-fc87-47d4-bdd9-3f6a8ea96100.png)
...
![image-20230616180412200](/images/Java/image-20230616180412200.png)

简单的来说就是

![image-20230616180421789](/images/Java/image-20230616180421789.png)
...
![img](/images/Java/abstract-01.png)
...
![img](/images/Java/abstract-02.png)

第二处在尝试定义 abstract 的方法上，提示“抽象方法所在的类不是抽象的”，见下图。

![img](/images/Java/abstract-03.png)
...
![img](/images/Java/abstract-04.png)
...
![img](/images/Java/abstract-05.png)
...
![img](/images/Java/interface-03.png)
...
![img](/images/Java/interface-04.png)
...
![img](/images/Java/interface-05.png)

**4）接口的抽象方法不能是 private、protected 或者 final**，否则编译器都会报错。

![img](/images/Java/interface-06.png)
...
![img](/images/Java/interface-07.png)
...
![image-20230616222707040](/images/Java/image-20230616222707040.png)
...
![image-20230616222313161](/images/Java/image-20230616222313161.png)

首先我们话一个图帮助我们来理解

![image-20230616222323833](/images/Java/image-20230616222323833.png)
...
![image-20230616222514213](/images/Java/image-20230616222514213.png)
...
![image-20230616222830270](/images/Java/image-20230616222830270.png)

![image-20230616222844663](/images/Java/image-20230616222844663.png)

![image-20230616222853446](/images/Java/image-20230616222853446.png)
...
![img](/images/Java/inner-class-26fc0242-134a-4588-a52d-7da962fc3fb9.png)
...
![img](/images/Java/inner-class-c0b9bdf5-cb12-45fc-b362-cb14d5d44fdc.png)
...
![img](/images/Java/inner-class-69523196-37fe-43c6-a52e-5a8c94fdd2d8.png)
...
![img](/images/Java/19-04.png)

“然后在静态方法中访问非静态方法，编译器同样不允许。”

![img](/images/Java/19-05.png)
