...
![](/images/python/WEBRESOURCE0d074488d6c66e715928ca70784636f5.png)



我们发现这个网站的爬取是非常的简单的。

![](/images/python/WEBRESOURCE868957658212db9e50f7f16a87fc7e2e.png)

结构非常的简单。



![](/images/python/WEBRESOURCE6c2ace8f14ed2378da7026ee5f3bb55b.png)

这个分页的规律也很简单



![](/images/python/WEBRESOURCE01f85579833cf63a72eb437eed64ace8.png)
...
![](/images/python/WEBRESOURCEbe6acd476dd351b0afc6cd8206c2764a.png)
...
![](/images/python/WEBRESOURCEcf51a0666b546e23bacd9092a5ffe9cc.png)

如果为false，他就是立即下载的意思。



![](/images/python/WEBRESOURCE4eadb640f20bc43e4c7ed60bab47fbc0.png)

## 3.爬取csdn

![](/images/python/WEBRESOURCE7b21ccc4ec5fc5127865335db04893b5.png)
...
![](/images/python/WEBRESOURCE6e0b30f4c887a8e177f784d1783b303d.png)
...
![](/images/python/WEBRESOURCE77c2f531dee0f1b88a7fb68469e6c14c.png)

我们发现这个username就是一个博主姓名的标志

以及他的一些返回信息。

![](/images/python/WEBRESOURCE9a45ee2398bb3d446308e6e29e22fe5f.png)
...
![](/images/python/WEBRESOURCEbf881351a050b499530aa805c7eb39c4.png)
...
![](/images/python/WEBRESOURCEd16e9915e5b0a407d7ca3ed86ecedd21.png)
...
![](/images/python/WEBRESOURCE5e2f5eb7527f05ccfc09d5b046dc2ab9.png)



![](/images/python/WEBRESOURCE8c4375cdb272843c71a024bde912eda4.png)



![](/images/python/WEBRESOURCEfb45412f5c5b64358a1448d8f76b2c88.png)
...
![](/images/python/WEBRESOURCE20492907112cceff749fa0dd28190306.png)
...
![](/images/python/WEBRESOURCEc7cccd5854507d63597cfd282bbb6f50.png)
...
![](/images/python/WEBRESOURCE7e06e10e290911a067e887fab049eea2.png)
...
![](/images/python/WEBRESOURCE5d8bed84f00c9a3dedf90c25cef7203b.png)
...
![](/images/python/WEBRESOURCEe60d1e14b35fa0c170469c93fd0f01f7.png)
...
![](/images/python/WEBRESOURCEe856df966a5cd1a7053f00796c33f022.png)

很显然是没有加密过的。



![](/images/python/WEBRESOURCE5f3beaca1475b6d9f65535d8ea9765a9.png)
...
![](/images/python/WEBRESOURCEd52c0fbe5898c7302512ef813e02428d.png)
...
![](/images/python/WEBRESOURCEd0116a7ff1d06458d323bcec77e0036e.png)
...
![](/images/python/WEBRESOURCEb5e92d79462a54c084592ed4498d9639.png)
...
![](/images/python/WEBRESOURCE920c6e2b9a5c8fd53bea0b0b3db151e5.png)
...
![](/images/python/WEBRESOURCEac9168ebd36e7cbfb61c2f546c711c32.png)
...
![](/images/python/WEBRESOURCEcd7ffc7e60aa667e53918980c96e8c26.png)

发现了这个，我们右键把她阻断了



![](/images/python/WEBRESOURCE4af84c6a546a5051849bb191bf887b3a.png)
...
![image-20230716114503545](/images/python/image-20230716114503545.png)
...
![image-20230716135047326](/images/python/image-20230716135047326.png)
...
这样就算是可以爬取一页了。
下面我们来进行分页数据解析
![image-20230716135113282](/images/python/image-20230716135113282.png)
我们从这个后一页来当做一个突破点
![image-20230716135121962](/images/python/image-20230716135121962.png)
输出的是这个![image-20230716135129828](/images/python/image-20230716135129828.png)
我们发现在第四页就停住了
